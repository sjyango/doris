...
suite("test_left_sort_merge_join1", "query,p0") {

    def tableName = "test_left_sort_merge_join1"

    sql "set equivalent_join_using_sort_merge_join = true"

    sql """drop table if exists ${tableName}"""
    sql new File("""${context.file.parent}/ddl/test_left_sort_merge_join1.sql""").text
